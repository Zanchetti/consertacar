...
$marca = $control->selecionar(addslashes($_GET['id']));
?>
                            ...
                            <form action="" method="POST" id="form">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="campo_esquerda">
                                        <input type="text" class="form-control" value="<?php echo (isset($_POST['nome'])) ? $_POST['nome'] : $marca->nome ?>" name="nome" id="nome" placeholder="Informe o nome" required="required" data-toggle="tooltip" title="Informe o nome" data-placement="auto"/>
                                    </div>
                                </div>		
                            </form>
                        </div>
