...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($control->inserir($_POST['modelo'], $_POST['placa'], $_POST['ano'], $_POST['id_cliente'], $_POST['id_marca'])) {
                        ...
                        <div class="panel panel-default">
                            <form action="" method="POST" id="form">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="campo_esquerda">
                                        <input type="number" class="form-control" value="<?php echo (isset($_POST['ano'])) ? $_POST['ano'] : "" ?>" name="ano" id="ano" placeholder="Informe o ano: " required="required" data-toggle="tooltip" title="Informe o ano: " data-placement="auto"/>
                                    </div>
                                    ...
                                    <div class="campo_direita">
                                        <select name="id_marca">
                                            ...
                                            <?php foreach ($marcas as $marc) { ?>
                                                <option value="<?php echo $marc->id ?>"><?php echo $marc->nome ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
