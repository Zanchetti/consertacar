                        ...
                        <div class="panel panel-default">
                            <form action="" method="POST" id="form">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="campo_esquerda">
                                        <input type="text" class="form-control" value="<?php echo (isset($_POST['data_nascimento'])) ? $_POST['data_nascimento'] : $cliente->data_nascimento ?>" name="data_nascimento" id="data_nascimento" placeholder="Informe a data de nascimento" required="required" data-toggle="tooltip" title="Informe a data de nascimento" data-placement="auto"/>
                                    </div>
                                </div>		
                            </form>
                        </div>
