...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {    
    if ($control->inserir($_POST['nome'], $_POST['email'], $_POST['senha'])) {
                            ...
                            <form action="" method="POST" id="form">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="campo_direita">
                                        <input type="email" class="form-control" value="<?php echo (isset($_POST['email']) ? $_POST['email'] : "")?>" name="email" id="email" placeholder="Informe o e-mail" required="required" data-toggle="tooltip" title="Informe o e-mail" data-placement="auto" />
                                    </div>
                                    <div class="campo_esquerda">
                                        <input type="password" class="form-control" value="" name="senha" id="senha" placeholder="Informe a senha" required="required" data-toggle="tooltip" title="Informe a senha" data-placement="auto"/>
                                    </div>
                                </div>		
                            </form>
                        </div>
